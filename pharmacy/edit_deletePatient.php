...
<!-- bg-primary , bg-success , bg-warning , bg-info  and bg-danger  bg-light bg-dark -->
	...
	<div class="container-fluid form-color bod">
			...
			<h1 align="center">Edit Or Delete Patient</h1>
			<div class="row">
				<div class="col-sm-1"></div>
				<div class="col-sm-10">
					<form class="form-horizontal navbar-expand-md reg" method="post" action="edit_deletePatient.php" enctype="multipart/form-data">
