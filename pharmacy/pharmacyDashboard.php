...
<!-- bg-primary , bg-success , bg-warning , bg-info  and bg-danger  bg-light bg-dark -->
			...
			<ul class="navbar-nav container-fluid">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdown-target">
							...
							<a href="index.php" class="dropdown-item">Register</a>
							<div class="dropdown-divider"></div>
							<a href="edit&deletePatient.php" class="dropdown-item">Update</a>
				...
				<li class="nav-item active">
					<a href="patientRegister.php" class="nav-link">Register</a>
				</li>
				<li class="nav-item active">
					<a href="registerMedicine.php" class="nav-link">RegisterMedicine</a>
				</li>
				<li class="nav-item active">
					<a href="registration.php" class="nav-link">Deliver_Medicine</a>
				</li-->
				<li class="nav-item active">
					<a href="edit_deletePatient.php" class="nav-link">EditPatient</a>
				</li>
				<li class="nav-item active">
					<a href="allPatient.php" class="nav-link">PatientDetail</a>
				</li>
				<li class="nav-item active">
					<a href="allMedicine.php" class="nav-link">MedicineDetail</a>
				</li>
				<li class="nav-item active">
	...
	<div class="container-fluid form-color masthead">
        ...
        <!-- <a href="" target="_BLANK"> Visit the new website</a><br><br>
        <a href="" target="_BLANK">A talk on Heart Health along with ASTER MIMS</a> -->
      </center>
					</marquee>
				</div>
			</div>
		...
		<div class="amenities " id="ameni5ties" style="margin-top: 50px;">
...
<script>
		...
		var images = Array("../images/nitcDoc.jpg","../images/doctor1.jpg");
		    ...
		    function loadimg(){
		       ...
		       $('.masthead').animate({ opacity: 1 }, 500,function(){        
		            $('.masthead').animate({ opacity: 0.7 }, 100,function(){
		                ...
		                $('.masthead').css("background-image",'linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.7)),url("'+newimage+'")',"height",'500px'); 
